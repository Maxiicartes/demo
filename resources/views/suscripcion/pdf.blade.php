...
<body>
    ...
    <div style="display: flex; justify-content: space-between; padding-top: 5%; text-align:center;">
        <div>
            <h3 class="colorMod">Suscripción a {{$suscripcion->nombre}}</h3>
        </div>
    </div>
        ...
        <div class="div1">
            ...
            <table id="table">
                ...
                <tr>
                    ...
                    <td class="tdMod colorMod " style="text-align: center;">
                        {{$suscripcion->fecha_instalacion}}
                    </td>
                </tr>
                <tr>
                    <th class="tdMod colorMod titulo">Fecha de la última actualización:</th>
                    <td class="tdMod colorMod " style="text-align: center;">
                        <span>{{$suscripcion->fecha_ultima_actualizacion}}</span>
                    </td>
                </tr>
                <tr>
                    <th class="tdMod colorMod titulo">Fecha de expiración:</th>
                    <td class="tdMod colorMod " style="text-align: center;">
                ...
                <tr>
                    ...
                    <td class="tdMod colorMod " style="text-align: center;">
                        <span>{{$suscripcion->unidad}}</span>
                    </td>
                </tr>
                <tr>
                    <th class="tdMod colorMod titulo">Responsable:</th>
                    <td class="tdMod colorMod " style="text-align: center;">
                        <span>{{$suscripcion->responsable}}</span>
                    </td>
                </tr>
